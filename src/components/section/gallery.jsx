        ...
        {galleryData.map(({ id, img, img_desc, img_title, link }) => {
          return (
            <div
              ...
              className={` ${expendItem === id ? 'lg:basis-[47%] basis-[50%]' : 'lg:basis-[20%] basis-[30%]'} flex-grow sm:min-h-[750px] min-h-[420px] overflow-hidden group transition-all duration-700 relative`}
            >
