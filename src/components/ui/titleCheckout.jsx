  ...
  if (size === '10xl') {
    return (
      <motion.h1
        ...
        className={cn(
          'text-transparent webkit-text-stroke-width-1 webkit-text-stroke-secondary xl:text-[330px] lg:text-[200px] md:text-[170px] sm:text-[140px] text-[100px]  whitespace-nowrap font-extrabold leading-[1.30] overflow-hidden',
          className,
        )}
      >
        {children}
