...
const CheckoutForm = ({ customerInfo, setCustomerInfo }) => {
  ...
  useEffect(() => {
    document.body.style.cssText =
      'overflow:auto !important; margin-right:0 !important';
  ...
  return (
    <form>
        ...
        <div>
          <Select onOpenChange={setOpen} onValueChange={setCountry}>
            ...
            <SelectContent className="rounded-none py-[14px] bg-primary">
              <SelectItem
                value="united-states"
                className="text-lg font-medium cursor-pointer text-secondary-foreground focus:bg-transparent focus:text-accent-transparent"
              >
                United States
              </SelectItem>
              <SelectItem
      ...
      <Textarea
        className={
          'placeholder:text-primary font-medium rounded-none py-[14px] text-lg mt-11 min-h-[200px] outline-none border-[1px] border-primary'
        }
        onChange={handleInputChange}
