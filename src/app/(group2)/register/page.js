          ...
          <div className='login-page-form bg-secondary h-full flex flex-col justify-center px-3.5 lg:px-7.5 py-8.5 lg:py-17.5'>
            <form id="checkOutForm" className="contact-form">
              <div className='mb-3.5 lg:mb-7.5'>
                <label className="text-primary mb-1" for="userName">Username*</label>
                <InputFiled id={"userName"} type={"text"} className={'bg-white'} />
              </div>
              <div className='mb-3.5 lg:mb-7.5'>
                <label className="text-primary mb-1" for="userName">Email*</label>
              ...
              <div className='mb-3.5 lg:mb-7.5'>
                <label className="text-primary mb-1" for="usrerPassword">Confirm Password*</label>
                <InputFiled id={"usrerPassword"} type={"password"} className={'bg-white'} />
              </div>
